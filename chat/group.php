...
<body>
    ...
    <a style="color: #000;text-align:center;" href="../"><h1 style="font-weight:100;margin-bottom:20px;">AnonMessaging</h1></a>
        <h1 style="font-weight:300;">Conversation with: 
        <!-- <u><a style="color: #000;" href="../profile/index.php?id=<?php echo $name; ?>"><?php echo findName($name); ?></a></u> -->
        </h1>
        <br><hr><br>
        <form method="POST">
        ...
        <div class="message">
            ...
            <a style="color:#000;" href="../profile/index.php?id=ID"><h3 style="font-weight:300;">NAME</h3></a>
            <p>DATE</p>
            <p>User Points: test</p>
